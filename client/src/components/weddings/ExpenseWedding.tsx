...
interface ExpenseProps extends SavingWedding {
  setStartDate: any;
...
const ExpenseWedding: React.FC<ExpenseProps> = ({
  husband,
  bride,
  reserve_pay,
  husband_rental,
      ...
      <Content>
        ...
        <h3>
          ...
          {(
            ...
            (function () {
              if (present === 'privacy') {
                return present_price * husband_present_num;
