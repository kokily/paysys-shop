...
const ReadWeddingMobile: React.FC<ReadWeddingProps> = ({
  wedding,
  onList,
  onBack,
  onUpdate,
      ...
      {wedding && (
        <Content>
          <h3 className="name">
            ...
            <strong style={{ color: 'pink' }}> ♡</strong> 신부님: <strong>{wedding.bride}</strong>
          </h3>

          <h4>
            웨딩일자: {new Date(wedding.wedding_at).toLocaleDateString()} {wedding.event_at}
          </h4>
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td>{wedding.sum_rental.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</td>
              </tr>
              ...
              <tr>
                ...
                <td>{wedding.sum_company.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</td>
              </tr>
              ...
              <tr>
                ...
                <td>{wedding.sum_add.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</td>
              </tr>
              ...
              <tr>
                ...
                <td>{wedding.sum_today.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</td>
              </tr>
              ...
              <tr>
                ...
                <td>{wedding.sum_bouquet.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</td>
              </tr>
              ...
              <tr>
                ...
                <td>{wedding.sum_ceremony.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</td>
              </tr>
              ...
              <tr>
                ...
                <td>{wedding.sum_hanbok.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</td>
              </tr>
              ...
              <tr>
                ...
                <td>{wedding.sum_play.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</td>
              </tr>
              ...
              <tr>
                ...
                <td>{wedding.sum_anthem.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</td>
              </tr>
              ...
              <tr>
                ...
                <td>{wedding.sum_moderator.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</td>
              </tr>
              ...
              <tr>
                ...
                <td>{wedding.sum_officiate.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</td>
              </tr>
              ...
              <tr>
                ...
                <td>{wedding.sum_etc.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</td>
              </tr>
              ...
              <tr>
                ...
                <td>{wedding.sum_conv.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</td>
              </tr>
              ...
              <tr>
                ...
                <td>{wedding.sum_wedding.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</td>
              </tr>
            </tbody>
          </table>
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td>{wedding.sum_num.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}명</td>
              </tr>
              ...
              <tr>
                ...
                <td>{wedding.sum_meal.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</td>
              </tr>
            </tbody>
          </table>
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td>{wedding.sum_present.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}원</td>
              </tr>
            </tbody>
          </table>
